...
# Allow all egress (for package updates, EFS access, etc.)
...
# SSM access for alternative connectivity
resource "aws_iam_role_policy_attachment" "bastion_ssm" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
  role       = aws_iam_role.bastion.name
}

# Read-only access to EFS (for mounting)
...
################################################################################
# EFS Security Group Rule (allow bastion to access EFS)
################################################################################
